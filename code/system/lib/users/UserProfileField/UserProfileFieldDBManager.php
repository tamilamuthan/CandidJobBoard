	...
	public static function saveUserProfileField($user_profile_field, $recursive = false)
	{
		...
		if ($user_group_sid) {
			...
			if ($userFieldType == 'location') {
				if (!$sid) {
					$userProfileFeld = new SJB_UserProfileField(array('id' => 'Country', 'caption' => 'Country', 'type' => 'string'));
					...
					$userProfileFeld = new SJB_UserProfileField(array('id' => 'State', 'caption' => 'State', 'type' => 'string'));
					$userProfileFeld->setUserGroupSID($user_group_sid);
					$userProfileFeld->addParentSID($user_profile_field->getSID());
					self::saveUserProfileField($userProfileFeld, true);
					...
					$userProfileFeld->addParentSID($user_profile_field->getSID());
					self::saveUserProfileField($userProfileFeld, true);
					$userProfileFeld = new SJB_UserProfileField(array('id' => 'ZipCode', 'caption' => 'ZipCode', 'type' => 'string'));
					$userProfileFeld->setUserGroupSID($user_group_sid);
					$userProfileFeld->addParentSID($user_profile_field->getSID());
					self::saveUserProfileField($userProfileFeld, true);
					$userProfileFeld = new SJB_UserProfileField(array('id' => 'Latitude', 'caption' => 'Latitude', 'type' => 'float'));
					$userProfileFeld->setUserGroupSID($user_group_sid);
					$userProfileFeld->addParentSID($user_profile_field->getSID());
					self::saveUserProfileField($userProfileFeld, true);
					$userProfileFeld = new SJB_UserProfileField(array('id' => 'Longitude', 'caption' => 'Longitude', 'type' => 'float'));
					$userProfileFeld->setUserGroupSID($user_group_sid);
					$userProfileFeld->addParentSID($user_profile_field->getSID());
					self::saveUserProfileField($userProfileFeld, true);
				}
