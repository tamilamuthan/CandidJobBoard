{breadcrumbs}<a href="{$GLOBALS.site_url}/system/payment/gateways/">[[Payment Methods]]</a> &#187; {$gateway.caption}{/breadcrumbs}
	...
	<form method=post>
		<table>
			...
			{foreach from=$form_fields key=field_id item=field_info}
				<tr class="{cycle values='oddrow,evenrow' }" {if $field_id == 'id'}style="display: none;"{/if}>
