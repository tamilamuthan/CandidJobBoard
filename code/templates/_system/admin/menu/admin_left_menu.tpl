...
<a href="{$GLOBALS.admin_site_url}/">
	<div id="ImgIdPlugins" class="leftMenu">
		<span id="stImgIdPlugins" class="menuName">
			<span class="borders">[[Dashboard]]</span>
		</span>
...
{foreach from=$left_admin_menu key="section" item="section_items" name='menu_block'}
	{if $section == 'Pages'}
		<a href="{$GLOBALS.admin_site_url}/user-pages/">
			<div id="ImgIdPlugins" class="leftMenu">
				<span id="stImgIdPlugins" class="menuName">
					<span class="borders">[[Pages]]</span>
				</span>
				<span id="s{$section_items.id}" class="menuArrow"></span>
			</div>
		</a>
...
<a href="{$GLOBALS.admin_site_url}/system/miscellaneous/plugins/">
	<div id="ImgIdPlugins" class="leftMenu">
		<span id="stImgIdPlugins" class="menuName">
			<span class="borders">[[Plugins]]</span>
		</span>
		<span id="s{$section_items.id}" class="menuArrow"></span>
	</div>
</a>
