{breadcrumbs}
	[[Job Postings]]
{/breadcrumbs}
<h1><img src="{image}/icons/linedpaper32.png" border="0" alt="" class="titleicon"/> [[Job Postings]]</h1>
<div class="right">
	<a href="{$GLOBALS.site_url}/import-listings/?listing_type_id={$listingsType.id}" class="grayButton">[[Import Jobs]]</a>
	<a href="{$GLOBALS.site_url}/export-listings/?listing_type_id={$listingsType.id}" class="grayButton">[[Export Jobs]]</a>
	<a href="{$GLOBALS.site_url}/add-listing/?listing_type_id={$listingsType.id|lower}" class="grayButton" style="margin-left: 15px !important;">[[Add New {$listingsType.name}]]</a>
</div>
