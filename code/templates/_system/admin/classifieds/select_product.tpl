		...
		<tr>
			<td colspan="3">
				<div class="align_right">
					<input type="button" name="next" value="[[Cancel]]" class="grayButton" onclick="location.href='{$GLOBALS.site_url}/add-listing/?listing_type_id={$listingType.id|lower}'" />
					<input type="submit" name="next" value="[[Next]]" class="grayButton" />
				</div>
			</td>
		</tr>
	</table>
