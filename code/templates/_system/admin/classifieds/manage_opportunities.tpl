...
{/breadcrumbs}
<h1><img src="{image}/icons/linedpaper32.png" border="0" alt="" class="titleicon"/> [[Opportunity Postings]]</h1>
<div class="right">
	<a href="{$GLOBALS.site_url}/import-listings/?listing_type_id={$listingsType.id}" class="grayButton">[[Import Opportunities]]</a>
	<a href="{$GLOBALS.site_url}/export-listings/?listing_type_id={$listingsType.id}" class="grayButton">[[Export Opportunities]]</a>
	<a href="{$GLOBALS.site_url}/add-listing/?listing_type_id={$listingsType.id|lower}" class="grayButton" style="margin-left: 15px !important;">[[Add New Opportunity Listing]]</a>
</div>
	...
	<form method="post" name="search_form">
		...
		<table  width="100%">
			...
			<tr>
				...
				<td>
					<input type="text" value="{if $companyName}{$companyName|escape:'html'}{/if}" name="company_name[like]" placeholder="[[Investor name or email]]" />
				</td>
			</tr>
			<tr>
				<td>[[Posted with]]: </td>
