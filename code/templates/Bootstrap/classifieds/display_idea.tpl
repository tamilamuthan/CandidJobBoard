...
{if $smarty.request.isBoughtNow}
	<div class="alert alert-bought-now text-center content-text">
		[[You have successfully posted your idea.]] <br/>
		<a href="{$GLOBALS.site_url}/my-listings/idea/" class="link">[[View your idea stats in "My Account" section]]
	...
	<div class="details-header">
		<div class="container">
			<div class="results text-left">
				{if $url == "/my-idea-details/{$listing.id}/"}
			...
			<div class="job-type">
				{display property='IdeaType' assign='IdeaType'}
				{if $IdeaType}
					<span class="job-type__value">{$IdeaType}</span>
				{/if}
...
<div class="details-footer  {if $GLOBALS.user_page_uri == '/idea-preview/'}idea-preview{/if}">
	<div class="container">
		{if $GLOBALS.user_page_uri == '/idea-preview/'}
