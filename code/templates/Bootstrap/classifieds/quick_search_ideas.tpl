<div class="container container-fluid quick-search">
	<div class="quick-search__wrapper well">
		<form action="{$GLOBALS.site_url}/ideas/" class="form-inline row">
			<input type="hidden" name="listing_type[equal]" value="Idea" />
			{if $searchId}
			...
			<div class="form-group form-group__btn">
				<button type="submit" class="quick-search__find btn btn__orange btn__bold ">[[Find Ideas]]</button>
			</div>
		</form>
	</div>
</div>