<div class="container container-fluid quick-search">
	<div class="quick-search__wrapper well">
		<form action="{$GLOBALS.site_url}/opportunities/" class="form-inline row">
			<input type="hidden" name="listing_type[equal]" value="Opportunity" />
			{if $searchId}
			...
			<div class="form-group form-group__btn">
				<button type="submit" class="quick-search__find btn btn__orange btn__bold ">[[Find Opportunities]]</button>
			</div>
		</form>
	</div>
</div>