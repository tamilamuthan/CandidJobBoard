...
<div class="details-body__left applicants">
    ...
    <div id="applicants-list">
        {foreach item=application from=$applications name=applications}
            <article class="media well listing-item {if in_array($listing.type.id, array('Job','Opportunity'))}listing-item__jobs{else}listing-item__resumes{/if}">
                ...
                <div class="media-body">
                    ...
                    <div class="listings-application-info clearfix">
                        ...
                        {if $application.file}
                            <a class="listings-application-info--item link" href="?appsID={$application.id}&amp;filename={$application.file|escape:"url"}">[[Idea file]]</a>
                        {/if}
                        {if $application.resumeInfo.Resume.file_name}
                            <a class="listings-application-info--item link" href="{$GLOBALS.site_url}{$application.resumeInfo|listing_url}?filename={$application.resumeInfo.Resume.saved_file_name|escape:'url'}">[[Idea file]]</a>
                        {/if}
